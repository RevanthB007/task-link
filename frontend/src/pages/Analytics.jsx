...
export const Analytics = () => {
    ...
    return (
        ...
        <div className='flex  items-center h-56 w-full mt-40 pl-11'> 
            <div className='h-full'><TodoChart type="completed"/> </div>
            <div className='h-full'><TodoChart type="assignment"/> </div>
